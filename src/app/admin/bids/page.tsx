...
import { TrendingUp, Search, AlertTriangle, Ban, DollarSign, RotateCcw, Eye, Flag } from 'lucide-react';
...
const mockBids: Bid[] = [
  ...
  },
  {
    id: 'BID-004',
    auctionId: 'AUC-002',
    auctionTitle: '2022 Honda CR-V EX',
    bidderName: 'David Wilson',
    bidderId: 'USR-104',
    amount: 980000,
    bidTime: '2025-10-18T13:15:00',
    isAutoBid: true,
  ...
  },
  {
    ...
    auctionId: 'AUC-002',
    auctionTitle: '2022 Honda CR-V EX',
    bidderName: 'Eva Martinez',
    bidderId: 'USR-105',
    amount: 970000,
    bidTime: '2025-10-18T13:10:00',
    isAutoBid: false,
...
export default function BidMonitoringPage() {
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400 mt-1">
          Monitor bidding activity and detect suspicious patterns
        </p>
      </div>
        ...
        >
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3 pt-4 border-t border-gray-200 dark:border-gray-800">
              {(selectedBid.status === 'active' || selectedBid.status === 'winning') && (
                <>
                  <button
        ...
        >
          <div className="space-y-4">
            <p className="text-sm text-gray-700 dark:text-gray-300">
              Are you sure you want to cancel this bid? The bidder's deposit will be refunded.
            </p>
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="Provide a reason for cancelling this bid..."
                rows={4}
            ...
            <div className="flex gap-3 pt-4 border-t border-gray-200 dark:border-gray-800">
              ...
              >
                {isProcessing ? 'Processing...' : 'Cancel Bid'}
              </button>
              <button
                onClick={() => {
                  setShowCancelModal(false);
      ...
      {selectedBid && (
        <ConfirmationModal
          ...
          onConfirm={handleRefundBid}
          title="Refund Deposit"
          message={`Are you sure you want to refund the bidding deposit of ${formatCurrency(selectedBid.amount * 0.1)} to ${selectedBid.bidderName}?`}
          confirmText="Refund"
          variant="warning"
