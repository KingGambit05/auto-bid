      ...
      {showRejectModal && (
        <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-6">
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-3 py-2 bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg text-sm mt-2 focus:ring-2 focus:ring-red-500 focus:border-transparent"
